...
class ConvolutionalProcessingBlock_BN_Residual(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_BN_Residual, self).__init__()
...
if args.block_type == 'conv_block':
    ...
    processing_block_type = ConvolutionalProcessingBlock_BN_Residual
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlock_BN
else:
